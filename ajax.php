...
if ($function['function'] == 'send_msg') {
    ...
    $query = "INSERT INTO `messages`(`session_id`,`sender`,  `sender_id` ,`receiver`, `receiver_id`, `msg`, `is_outgoing`, `last_msg`) values ('$session_id','$sender' , '$sender_id' , '$receiver' , '$receiver_id' , '$msg' , '1', '$msg') ";
    $result = mysqli_query($conn, $query);
